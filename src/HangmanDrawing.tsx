...
// the guilotine
// set the numberOfGuesses to be HangmanDrawingProps
    ...
    <div style={{ position: "relative"}} >
        ...
        <div 
            style={{ height:"400px", width:"10px", background:"black",
                marginLeft:"120px", // in the center we want it 
            }} // width => 250//2=125, subtract 5(from width is 10/2), become 120px marginLeft
        ></div>
